...
@app.route('/ucs538-assignment3-q2/')
def uploadForm():
    return render_template('uploadCompress.html')

@app.route('/ucs538-assignment3-q2', methods = ['POST'])
def uploadConvertFile():
    if request.method == 'POST':
        ...
        if file and isVideo(file):
            ...
            file.save(filePath)
            outputPath = compressVideo(filePath, int(request.form.get('compressionFraction')))
